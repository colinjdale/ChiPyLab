...
# -------------------- USER SETTINGS --------------------
IMG_PATH = "data/pixis_imgs/ushots/"
MAT_FILE = files[3]   # <-- set your .mat file name
...
VMAX = 0.3                    # e.g., 3.0 to cap OD color scale; None = auto 99th percentile
CMAP = "magma"               # e.g., "viridis", "plasma", "inferno", "magma", "cividis"
SAVE_OD_PDF = f"ushots_cold_{CMAP}.png"    # e.g., "od.pdf" to save, or "" to skip
# SAVE_OD_PDF = ""
...
## UShots (hot)
# X_MIN, X_MAX = 442, 572   # columns
# Y_MIN, Y_MAX = 75, 215   # rows

## UShots (cold)
X_MIN, X_MAX = 467, 597   # columns
Y_MIN, Y_MAX = 75, 215   # rows
...
SAVE_FILE_PATH = "../" + "data/imgs/" + SAVE_OD_PDF
...
def main():
    ...
    if SAVE_OD_PDF:
        ...
        print(f"Saved OD image to {SAVE_FILE_PATH}")
